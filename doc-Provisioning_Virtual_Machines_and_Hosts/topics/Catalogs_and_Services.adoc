...
. You can start the virtual machine provisioning process by clicking menu:Compute[Infrastructure > Virtual Machines], then click image:2007.png[](*Lifecycle*), and then image:1862.png[](*Provision VMs*).
. Select the image you are going to use, then click *Continue*. You can go through the steps in the provisioning dialog.
