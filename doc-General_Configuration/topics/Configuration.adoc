...
. Make sure the desired logo is accessible from the computer where you are running the {product-title_short} user interface. The file must be in portable network graphics (png) format with dimensions of 350 x 70.
. From the settings menu, select *Configuration*.
. Click on the *Settings* accordion, then click *Zones*.
. Click the zone where the {product-title} server is located.
. Click on the server.
...
. Make sure the logo that you want to use is accessible from the computer where you are running the {product-title_short} user interface. The file must be in PNG format with dimensions of 1280 x 1000.
. From the settings menu, select *Configuration*.
. Click on the *Settings* accordion, then click *Zones*.
. Click the zone where the server is located.
. Click on the server.
...
. Click on the server.
. Click the *Custom Logos* tab.
. In *Custom Login Panel Text*, enter the text that you want to show on the login screen.
image:2075.png[]
