...
* Virtual machine provision from global region
* Invoke service provision request from global region  
* Virtual machine power operations from global region
* Virtual machine retirement from global region
* Virtual machine reconfigure from global region
