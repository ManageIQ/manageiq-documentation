...
This document describes the methods available for use in CloudForms Management Engine.
...
Red Hat CloudForms ships with a core set of Ruby gems used by the CloudForms Management Engine Rails Application.
The Ruby gems in this set are subject to change, and have changed since CloudForms 3.1 (CloudForms Management Engine 5.3). If you are calling gems using Automate that are no longer in the CloudForms Management Engine Appliance, you can install them by using the +gem install+ command. 
...
The https://access.redhat.com/documentation/en-US/Red_Hat_CloudForms/4.0/html/Release_Notes/index.html[Red Hat CloudForms 4.0 Release Notes] list Ruby gems that have been added, updated, or removed in the latest version of CloudForms Management Engine.
...
:leveloffset: 2
include::topics/About_evm.root.adoc[]


:leveloffset: 2
include::topics/Method_Hierarchy.adoc[]


:leveloffset: 2
include::topics/Base_Methods.adoc[]


:leveloffset: 2
include::topics/Availability_Zones_availability_zone.adoc[]


:leveloffset: 2
include::topics/Classifications_classification.adoc[]


:leveloffset: 2
include::topics/Cloud_Networks_cloud_network.adoc[]


:leveloffset: 2
include::topics/Cloud_Resource_Quotas_cloud_resource_quota.adoc[]


:leveloffset: 2
include::topics/Cloud_Subnets_cloud_subnet.adoc[]


:leveloffset: 2
include::topics/Cloud_Tenants_cloud_tenant.adoc[]


:leveloffset: 2
include::topics/Customization_template.adoc[]
...
:leveloffset: 2
include::topics/Management_System_Events_ems_event.adoc[]


:leveloffset: 2
include::topics/Management_System_Folders_ems_folder.adoc[]
...
:leveloffset: 3
include::topics/Cloud_Providers_ems_cloud.adoc[]


:leveloffset: 2
include::topics/Firewall_Rules_firewall_rule.adoc[]


:leveloffset: 2
include::topics/Flavors_flavor.adoc[]


:leveloffset: 2
include::topics/Floating_IPs_floating_ip.adoc[]


:leveloffset: 2
include::topics/Guest_Applications_guest_application.adoc[]


:leveloffset: 2
include::topics/Guest_Device_guest_device.adoc[]


:leveloffset: 2
include::topics/Hardware_hardware.adoc[]
...
The following table lists the metric types available for the [literal]+get_realtime_metric(metric, range, function)+ method for hosts. 
...
The following Ruby snippet demonstrates using the [literal]+get_realtime_metric(metric, range, function)+ method using the [literal]+v_pct_cpu_ready_delta_summation+ metric. 
...
:leveloffset: 3
include::topics/Hosts_Vmware_ESX_host_vmware_esx.adoc[]


:leveloffset: 2
include::topics/LAN_lan.adoc[]
...
Request objects are submitted to CloudForms Management Engine Server for processing.
...
:leveloffset: 3
include::topics/Miq_host_provision_request.adoc[]


:leveloffset: 3
include::topics/Miq_provision_request.adoc[]
...
:leveloffset: 3
include::topics/Automation_task.adoc[]


:leveloffset: 3
include::topics/Miq_host_provision.adoc[]
...
:leveloffset: 4
include::topics/Adding_Disks_to_OpenStack_Instance_Provisioning.adoc[]


:leveloffset: 4
include::topics/Booting_OpenStack_Instances_from_Volume.adoc[]


:leveloffset: 4
include::topics/VM_Provisioning_for_Clouds_Task_miq_provision_cloud.adoc[]


:leveloffset: 3
include::topics/Service_template_provision_task.adoc[]


:leveloffset: 3
include::topics/Service_Reconfiguration_Task_service_reconfigure_task.adoc[]


:leveloffset: 3
include::topics/Vm_migrate_task.adoc[]


:leveloffset: 2
include::topics/Proxies_miq_proxy.adoc[]
...
| 
								...
								Returns CloudForms Management Engine Servers Zone
...
| 
								...
								Returns CloudForms Management Engine Servers Region Number
...
| 
								...
								Returns CloudForms Management Engine Servers Region Name
...
:leveloffset: 2
include::topics/Network_network.adoc[]


:leveloffset: 2
include::topics/Pxe_image.adoc[]


:leveloffset: 2
include::topics/Pxe_server.adoc[]


:leveloffset: 2
include::topics/Security_Groups_security_group.adoc[]


:leveloffset: 2
include::topics/Service2.adoc[]


:leveloffset: 2
include::topics/Service_Resource_service_resource.adoc[]


:leveloffset: 2
include::topics/Service_Template.adoc[]


:leveloffset: 2
include::topics/Snapshot_snapshot.adoc[]
...
:leveloffset: 2
include::topics/Switch_switch.adoc[]
...
| 
								...
								Get the value of specified CloudForms Management Engine Server key from the object
...
| 
								...
								List all CloudForms Management Engine Server custom keys for the object
...
| 
								...
								Set a custom CloudForms Management Engine Server key value
...
| 
								...
								If VM was created using CloudForms Management Engine Server provisioning, this is the miq_provision task instance that created the VM
...
The following table lists the metric types available for the [literal]+get_realtime_metric(metric, range, function)+ method for virtual machines. 
...
:leveloffset: 4
include::topics/VMs_for_Clouds_vm_cloud.adoc[]


:leveloffset: 2
include::topics/Windows_image.adoc[]
...
:leveloffset: 3
include::topics/Category_and_Tags_Methods_Example1.adoc[]


:leveloffset: 2
include::topics/Quota2.adoc[]
