...
[NOTE]
====
If VDDK does not work for your environment, see xref:Configuring_the_1_1_rhv_environment_for_ssh[].
====
...
[NOTE]
====
If VDDK does not work for your environment, see xref:Configuring_the_1_1_osp_environment_for_ssh[].
====
