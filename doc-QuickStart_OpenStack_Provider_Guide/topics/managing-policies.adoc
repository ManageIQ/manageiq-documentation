...
[NOTE]
=============
For more detailed information about {product-title_short} policies, see  https://access.redhat.com/documentation/en/red-hat-cloudforms/4.5/single/assigning-a-custom-analysis-profile-to-a-virtual-machine/[Assigning a Custom Analysis Profile to a Virtual Machine] and  https://access.redhat.com/documentation/en/red-hat-cloudforms/4.5/single/policies-and-profiles-guide/[Policies and Profiles Guide]. 
=============
