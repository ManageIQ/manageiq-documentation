...
[NOTE]
====
These procedures describe how to install and configure a basic CloudForms environment. For more options, see the link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.6/[CloudForms documentation].
====
...
[discrete]
==== Enabling Git Repositories

*(%AP: Do Git repositories need to be enabled? See https://docs.google.com/document/d/19345CNVTvDWgTz2hjavbyPn2yk26cM0fTKJnijfBsyY/edit#heading=h.bm32a1ypyozf. Also, do they need to add v2v Automation Domain?)*
