...
The link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.0/release-notes/release-notes[Red Hat CloudForms 4.0 Release Notes], list Ruby gems that have been added, updated, or removed in the latest version of CloudForms Management Engine.
