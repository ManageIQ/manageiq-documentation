...
You can configure the Red Hat Virtualization (RHV) conversion hosts to use the VMware Virtual Disk Development Kit (VDDK) with Ansible playbooks. VDDK converts the VMware disks.
...
You can configure the Red Hat OpenStack Platform (RHOSP) conversion hosts to use the VMware Virtual Disk Development Kit (VDDK) with Ansible playbooks. VDDK converts the VMware disks.
