...
You can collect SSH public keys of the VMware hypervisors either when you configure the VMware hypervisors for SSH transformation or by using `ssh-keyscan`:
