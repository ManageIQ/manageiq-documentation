...
Review the xref:Questions_to_ask_before_migration_{context}[questions to ask before migration] and xref:Recommendations_for_migration_{context}[migration recommendations and best practices] before planning your migration.
