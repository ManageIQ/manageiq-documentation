...
. (Optional) Select *Snapshot VM memory* for the snapshot to preserve the virtual machine's current runtime state. This option will appear only if the VM *Power State* is image:2143.png[](*On*). 
. Click *Create*.
