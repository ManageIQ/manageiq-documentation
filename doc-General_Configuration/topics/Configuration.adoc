...
. If you are restoring a database backup on a high availability environment, stop the `repmgrd` service. This is not required in other {product-title_short} configurations.
+
----
...
. Enter `Y` to confirm.
. If you are restoring a database backup on a high availability environment, start the `repmgrd` service. This is not required in other {product-title_short} configurations.
+
----
