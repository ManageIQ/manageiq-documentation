...
These procedures assume that you have answered these questions:

* xref:Deciding_how_many_conversion_hosts_to_create[]
* xref:Choosing_vddk_or_ssh_transformation[] For VDDK, the xref:VDDK_only_Downloading_and_copying_VDDK[VDDK prerequisite]] applies.
