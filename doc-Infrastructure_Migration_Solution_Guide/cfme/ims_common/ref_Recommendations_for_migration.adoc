...
* Configure your conversion hosts for VDDK transformation. SSH transformation, because it is slower and requires more configuration steps, is used only if VDDK cannot be used.
