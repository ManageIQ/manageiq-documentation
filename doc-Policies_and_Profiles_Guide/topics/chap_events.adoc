...
|Container Image Analysis Request |NEEDINFO.
...
|Pod Container Created | NEEDINFO.

|Pod Container Failed | NEEDINFO.

|Pod Container Killing  | NEEDINFO.

|Pod Container Started | NEEDINFO.

|Pod Container Stopped | NEEDINFO.

|Pod Container Unhealthy | NEEDINFO.
...
|Database Failover Executed |NEEDINFO.
...
|Host Maintenance Enter Request |NEEDINFO.

|Host Maintenance Exit Request  |NEEDINFO.

|Host Provision Complete |NEEDINFO.

|Host Reboot Request |NEEDINFO.

|Host Removed from Cluster |Check the condition when a host is removed
from a cluster.

|Host Reset Request |NEEDINFO.

|Host Shutdown Request |NEEDINFO.

|Host Standby Request |NEEDINFO.

|Host Start Request |NEEDINFO.

|Host Stop Request |NEEDINFO.

|Host Vmotion Disable Request |NEEDINFO.

|Host Vmotion Enable Request |NEEDINFO.

|Orchestration Stack Retire Request |NEEDINFO.

|Physical Server Reset |NEEDINFO.

|Physical Server Shutdown |NEEDINFO.

|Physical Server Start |NEEDINFO.
...
|Service Retire Request | NEEDINFO.
