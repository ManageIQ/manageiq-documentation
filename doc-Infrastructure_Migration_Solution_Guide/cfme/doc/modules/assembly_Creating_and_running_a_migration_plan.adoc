...
. Ensuring that the xref:Migration_plan_prerequisites[prerequisites] are met if your migration includes the following:

* VMware virtual machines that have been migrated in the past
* VMware virtual machines running RHEL or other Linux-based operating system
* Ansible playbooks for automating tasks before or after migration
