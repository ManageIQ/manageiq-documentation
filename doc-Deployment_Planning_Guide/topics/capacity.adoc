...
----
+
. Enable external md5 authentication. Modify the following line in `/var/lib/pgsql/data/pg_hba.conf` as shown below:
+
----
host    all      all    0.0.0.0/0     md5
----
+
. Enable PostgreSQL to listen for remote connections. Ensure the `listen_addresses` line in `/var/lib/pgsql/data/postgresql.conf` is as shown below:
+
----
listen_addresses  =  '*'
----
