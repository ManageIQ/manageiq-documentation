...
// assembly_Conversion_hosts.adoc
...
----
+
* If you are configuring your OpenStack Platform conversion host for VDDK, you can migrate the infrastructure.
...
.Upgrading the conversion hosts[[Upgrading_the_osp_conversion_hosts]]

Download the latest conversion host appliance and re-deploy the conversion hosts (see xref:Deploying_osp_conversion_hosts[Deploying OpenStack Platform conversion hosts]).
endif::osp[]
ifdef::rhv[]
+
...
.Upgrading the conversion hosts[[Upgrading_the_rhv_conversion_hosts]]
