...
[NOTE]
====
To use cloud-init, you must first install the cloud-init package and select the *Use Cloud-Init/Sysprep* option on the virtual machine.
====
...
The customized template will be ignored, and the provisioned virtual machine will not be marked with *Use cloud-init*, even though the template from which the virtual machine was provisioned, has it marked.
