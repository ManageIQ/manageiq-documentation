...
//Dayle note - this description looks newish, probably doesn't need editing

{product-title_short} can connect to OpenShift Container Platform containers providers and manage them similarly to infrastructure and cloud providers. This allows you to gain control over different aspects of your environment and answer questions, such as:
...
. Currently unused{product-title_short}
