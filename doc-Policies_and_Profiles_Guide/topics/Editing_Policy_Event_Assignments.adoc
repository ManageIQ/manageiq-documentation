...
ifdef::cfme[For a description of the events, see link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.1/policies-and-profiles-guide/#chap_events[Events].]
