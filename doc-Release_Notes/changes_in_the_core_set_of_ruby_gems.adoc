...
=== Removed Ruby Gem in CloudForms Management Engine 5.5
...
=== New Ruby Gem in CloudForms Management Engine 5.5

CloudForms Management Engine 5.5 adds the following new gem to the core set of Ruby gems included in the appliance:
