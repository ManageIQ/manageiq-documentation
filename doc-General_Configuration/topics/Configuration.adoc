...
{product-title_short} provides the ability to import and export schedules using the following Ruby script:
...
----
./tools/import_export_schedules.rb -o import -y ./filename.yaml
----
...
Note that the script works for all types of schedules (and between replicated databases), including: 
...
* Automation Task
* Service Template
>>>>>>> 50b3565... Added a section on ability to import/export schedules
