...
* If you are migrating a large number of virtual machines or re-migrating virtual machines, create a xref:Creating_a_csv_file_to_import_virtual_machines[CSV file] to import the virtual machines into the migration plan.
