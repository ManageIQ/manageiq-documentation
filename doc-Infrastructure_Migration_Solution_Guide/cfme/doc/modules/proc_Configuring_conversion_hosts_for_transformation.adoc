...
[[Upgrading_the_conversion_hosts]]
...
ifdef::osp[]
Download the latest conversion host appliance and re-deploying the conversion hosts (see xref:Deploying_osp_conversion_hosts[Deploying OpenStack Platform conversion hosts]).
endif::osp[]
