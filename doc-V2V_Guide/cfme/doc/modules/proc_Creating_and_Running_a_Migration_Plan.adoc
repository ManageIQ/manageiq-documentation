...
If you are migrating a large number of virtual machines, create a CSV file specifying the virtual machine names (mandatory) and provider (optional), in the following format:
...
+
When the migration is complete, a "Completed Migrations" message is displayed, with the number of successfully migrated virtual machines.
