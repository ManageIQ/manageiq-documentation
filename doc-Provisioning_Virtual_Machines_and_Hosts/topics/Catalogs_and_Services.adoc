...
. Click on a generic item class in the table to view its summary information.

[[create-generic-objects]]
===== Create Generic Objects Classes
include::common/create-generic-object.adoc[]

[[edit-generic-objects]]
===== Edit Generic Objects Classes
include::common/edit-generic-object.adoc[]

[[remove-generic-objects]]
===== Remove Generic Objects Classes
include::common/remove-generic-object.adoc[]
