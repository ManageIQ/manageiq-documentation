...
. Enter a *Full Name*, *Username*, *Password* with confirmation, *Email Address*, and choose a *Group* for the user. An email address is required; omitting the user email address can result in unsuccessful provisioning requests. 
+
image:2086.png[]
+
[IMPORTANT]
...
[NOTE]
====
See https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html-single/deployment_planning_guide/#appliance-types[Appliance Types] in the _Deployment Planning Guide_ for a summary of different types of appliances.
====
