...
* From the *User Type* list, select *User Principal Name* to type the user name in the format of _user@domainname_. Select *Email Address* to log in with the user's email address.
