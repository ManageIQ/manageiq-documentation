...
With this release, the Content Delivery Network, including both the Content
Delivery Network itself and Red Hat Satellite 6,  is the only supported
distribution channel for Red Hat CloudForms 4.0. Red Hat Network Satellite
