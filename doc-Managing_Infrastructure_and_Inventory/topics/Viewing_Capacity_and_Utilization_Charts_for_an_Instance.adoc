...
ifdef::cfme[For more information, see link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.2/general-configuration/#profiles[General Configuration].]
