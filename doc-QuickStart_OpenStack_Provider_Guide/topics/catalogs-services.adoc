...
[NOTE]
==================
For more information about catalogs and services, see https://access.redhat.com/documentation/en/red-hat-cloudforms/4.6/single/provisioning-virtual-machines-and-hosts/#catalogs-services[Catalogs and Services] from the https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.6/html-single/provisioning_virtual_machines_and_hosts/[
