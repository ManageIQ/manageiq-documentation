...
ifdef::cfme[]
See https://access.redhat.com/documentation/en/red-hat-cloudforms/4.6/paged/deployment-planning-guide/chapter-2-planning[Planning] in the _Deployment Planning Guide_ for information on setting up the correct disk space for the database-only appliances.
endif::cfme[]
