[id="Determining_your_migration_requirements"]
= Determining Your Migration Requirements

The following questions can help you to determine your migration requirements:
