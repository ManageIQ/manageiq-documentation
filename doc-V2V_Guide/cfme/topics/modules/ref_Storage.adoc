...
Go to the relevant section to attach your storage.
...
* link:https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html-single/Storage_Administration_Guide/index.html#ch-nfs[Network File System (NFS)] in the _Red Hat Enterprise Linux Storage Administration Guide_ for general information.
...
* link:https://access.redhat.com/documentation/en-us/red_hat_hyperconverged_infrastructure/1.0/html/deploying_red_hat_hyperconverged_infrastructure/configure-gluster-rhv-manager[_Configure Red Hat Gluster Storage as a Red Hat Virtualization storage domain_]
