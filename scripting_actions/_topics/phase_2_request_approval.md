...
| If a Request Approval requires manual approval, how does an Approver approve the request? | Log into {{ site.data.product.title_short }} as an approver/admin and navigate to **Virtual Machines > Requests** and then click on the request.                                                               |
