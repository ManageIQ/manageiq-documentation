...
The following commands are performed on the CLI of the CloudForms machine.

Changing the maximum number of concurrent migrations for a specific conversion host to `20`::
...
Changing the maximum number of concurrent migrations for a provider to `30`::
