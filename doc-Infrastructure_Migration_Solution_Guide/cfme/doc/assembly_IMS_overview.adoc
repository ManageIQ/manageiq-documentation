...
* xref:Preparing_the_target_environment[Configuring the target environment]. Configuring storage and networks, as well as installing and configuring software packages
