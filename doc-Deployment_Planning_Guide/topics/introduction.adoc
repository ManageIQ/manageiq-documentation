...
* Metrics Count: CloudForms will create a number of records/minute, rolled up hourly and daily, for each provider instance once Capacity & Utilization is enabled. See the second table for information on VMDB sizing to include metrics gathering.
