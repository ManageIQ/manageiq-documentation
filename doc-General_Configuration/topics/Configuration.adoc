...
[NOTE]
====
To update your appliances, see https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html-single/migrating_to_red_hat_cloudforms_4.5/[Updating {product-title}] in _Migrating to {product-title} 4.5_.
====
...
A user can only belong to one group, and a group can only be assigned one account role.
...
After creating a group, assign a user to the group by editing a user.
...
ifdef::cfme[]
See the section on _Centralized Administration_ in the https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html-single/deployment_planning_guide/#central-administration[Deployment Planning Guide] for an overview of the feature.
endif::cfme[]
