...
[NOTE]
======
If the appliance is registered to Red Hat Satellite, you can use content views to manage updates for CloudForms. For more information, see https://access.redhat.com/documentation/en/red-hat-satellite/6.2/content-management-guide/chapter-7-creating-content-views[Creating Content Views] in the _Red Hat Satellite 6 Content Management Guide_.
======
