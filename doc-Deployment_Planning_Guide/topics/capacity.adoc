...
ifdef::cfme[link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html/managing_providers/cloud_providers#adding_openstack_cloud_providers[Adding OpenStack Providers] in _Managing Providers_.]
...
* link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html/managing_infrastructure_and_inventory/sect_hosts#viewing_capacity_and_utilization_charts_for_a_host[Viewing Capacity and Utilization Charts for a Host]
* link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html/managing_infrastructure_and_inventory/sect_clusters#viewing_capacity_and_utilization_charts_for_a_cluster[Viewing Capacity and Utilization Charts for a Cluster]
* link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html/managing_infrastructure_and_inventory/sect_virtual_machines#to_view_capacity_and_utilization_charts_for_a_virtual_machine[Viewing Capacity and Utilization Charts for a Virtual Machine]
endif::cfme[]
