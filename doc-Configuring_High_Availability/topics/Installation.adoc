...
. For *Configure this server as a dedicated database instance?*, select `y`. Selecting this option configures this appliance as a database-only appliance, and therefore `evmserverd` processes will not run. 
+
[WARNING]
====
