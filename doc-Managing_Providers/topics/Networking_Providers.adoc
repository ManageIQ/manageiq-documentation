...
In {product-title}, a network manager is a inventory of networking entities on existing cloud and infrastructure providers managed by your {product-title_short} appliance.
