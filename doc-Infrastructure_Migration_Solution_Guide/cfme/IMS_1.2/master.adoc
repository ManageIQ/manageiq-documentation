...
The private key of the SSH key pair that is generated in this step will be used in xref:Configuring_conversion_hosts_cloudforms_ssh_{context}[Configuring the conversion hosts for SSH transformation].
...
|Instead of xref:Configuring_conversion_hosts_cloudforms_vddk_{context}[Configuring the conversion hosts for VDDK transformation] <a|Go to:

* xref:Configuring_conversion_hosts_cloudforms_ssh_{context}[Configuring the conversion hosts for SSH transformation]
