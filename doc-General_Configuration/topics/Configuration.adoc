...
ifdef::cfme[]
For information about tenancy in {product-title_short} and the difference between a tenant and project, see link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html-single/deployment_planning_guide/#tenants[Tenancy] in the _Deployment Planning Guide_.
endif::cfme[]
