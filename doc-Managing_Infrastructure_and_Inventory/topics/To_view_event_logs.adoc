...
ifdef::cmfe[See section link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.7-Beta/general-configuration/#profiles[Setting a Default Analysis Profile] in the General Configuration guide.]
