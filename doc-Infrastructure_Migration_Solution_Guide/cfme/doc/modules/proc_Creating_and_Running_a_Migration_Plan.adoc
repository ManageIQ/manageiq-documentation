...
+
You can select Ansible playbook services to run on the virtual machines in the migration plan before or after the migration. See xref:Advanced_migration_option-_automating_pre-_and_post-migration_tasks_with_ansible[] below.
