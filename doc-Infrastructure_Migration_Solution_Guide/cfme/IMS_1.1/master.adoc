...
:context: rhv
:rhv:
[id="Configuring_the_1_1_rhv_environment_for_ssh"]
[appendix]
= Configuring the Red Hat Virtualization environment for SSH transformation

If you cannot use VDDK transformation for migration, you can use SSH transformation.
...
[id="Configuring_the_1_1_rhv_conversion_hosts_for_ssh"]
...
:context: osp
:osp:
[id="Configuring_the_1_1_osp_environment_for_ssh"]
[appendix]
...
[id="Configuring_the_1_1_osp_conversion_hosts_for_ssh"]
