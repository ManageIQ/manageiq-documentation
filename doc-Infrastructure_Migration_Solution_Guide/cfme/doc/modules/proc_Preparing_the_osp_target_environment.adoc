...
//. Create projects for the conversion host and a migration destination.
// To do: Needs clarification from Nenad
...
[NOTE]
====
Outbound traffic is enabled by default. If you have changed this setting, you must enable ports 902 (CloudForms to VMware) and 5480 (`virt-v2v` to vCenter).
====
