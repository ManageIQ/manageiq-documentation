...
. There are two ways to specify the group to use: (EDIT)
...
* Select *Look Up LDAP Groups* to bring up the *LDAP Group Look Up* options.
.. In *User to Look Up*, enter the common name (`cn`) for a user in your LDAP group.
.. In *Username*, enter the (distinguished name?)
