...
=== Creating and configuring the Red Hat Virtualization conversion hosts

You can create the Red Hat Virtualization conversion hosts with the Universal Conversion Host Image.
...
You can create the Red Hat OpenStack Platform conversion hosts with the Universal Conversion Host Image.
