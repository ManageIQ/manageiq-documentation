...
Full CRUD is available on service_templates.
...
The following example bulk removes resources from multiple services:
...
The following example bulk removes all resources from multiple services:
