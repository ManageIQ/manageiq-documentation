...
* xref:Configuring_the_conversion_hosts[Configuring the conversion hosts].  Conversion hosts are Red Hat Virtualization hosts or Red Hat OpenStack Platform instances running `virt-v2v` and `virt-v2v-wrapper`, which perform the migration.
