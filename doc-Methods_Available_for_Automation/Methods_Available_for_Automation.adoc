...
The _Red Hat CloudForms 4.0 Release Notes_, available from https://access.redhat.com/documentation/en/red-hat-cloudforms/, list Ruby gems that have been added, updated, or removed in the latest version of CloudForms Management Engine.
