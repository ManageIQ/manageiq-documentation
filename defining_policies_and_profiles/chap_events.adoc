...
Events are triggers that cause a condition to be tested. {product-title} Control provides several Events, that can be divided
...
Analysis for a datastore is requested from the {product-title} console.
...
authentication credentials are not complete in the {product-title} console.
...
authentication credentials are changed in the {product-title} console.
...
|Provider Auth Incomplete Credentials |_For use only with {product-title} automate, for future use in policies._ Check the
condition if provider authentication credentials are not complete in the
C{product-title} console.
...
|Provider Auth Unreachable |_For use only with {product-title} automate, for future use in policies._ Check the condition if
...
provider authentication credentials entered in the {product-title} console are valid.
...
to delete a virtual machine from disk from the {product-title} console.
...
shut down the operating system of a virtual machine from the {product-title} console.
...
create a snapshot of a virtual machine from the {product-title} console.
