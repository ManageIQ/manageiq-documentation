...
* Bottleneck reports use the same mechanism to gather data as Capacity and Utilization reports. See, link:https://access.redhat.com/documentation/en/red-hat-cloudforms/version-4.0/deployment-planning-guide/#data_collected[Data Collected], for more information on enabling data collection in CloudForms Management Engine.
