...
include::Viewing_an_Object_Summary.adoc[]atom   
...
. On the provider summary page, click *Topology* in *Overview* box on the right-hand side of the page.
...
. Navigate to menu:settings menu[My Settings] and click on the *Visual* tab.
