...
. Installing and configuring CloudForms 5.0. See xref:Installing_cf_5_0_with_{context}[].

include::modules/ref_Vddk_note.adoc[]
include::modules/ref_Target_prerequisites.adoc[leveloffset=+1]
include::modules/ref_Software_compatibility_matrix_1_3.adoc[leveloffset=+1]

include::modules/proc_Installing_rhv_4_3.adoc[leveloffset=+1]
include::modules/proc_Installing_cf_5_0.adoc[leveloffset=+1]
...
. Installing and configuring CloudForms 5_0. See xref:Installing_cf_5_0_with_{context}[].
...
[discrete]
include::modules/ref_Software_compatibility_matrix_1_3.adoc[]
