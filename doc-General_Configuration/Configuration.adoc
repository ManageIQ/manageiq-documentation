...
* +Register+ to field provides options for the Customer Portal and RHN Satellite v6 for Red Hat Satellite 6.x servers. If switching to RHN Satellite v6, the page will refresh and a prompt for a Server URL will be included in the Customer Information area.
