...
ifdef::cfme[]
See https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html/deployment_planning_guide/planning#load-balancer[Using a Load Balancer] in the _Deployment Planning Guide_ for more details on these configuration steps.
endif::cfme[]
====
