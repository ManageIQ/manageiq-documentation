...
Use *Custom Logos* to display your own logo in the corner of the console or on the {product-title} login panel. Use the procedures below to upload a custom logo to the console, and to customize the login background and login panel text on the console.

[NOTE]
====
* After upgrading from an earlier {product-title} version, if your custom logo was already in use in the {product-title} version you upgraded from, and your logo image file is still in place in `vmdb/public/upload`, you may have to uncheck and recheck the option to *Use Custom Logo* to re-enable displaying your custom logo. See xref:uploading-a-custom-logo-to-the-console[] for the procedure on how to access the *Use Custom Logo* option, or if you want to upload another custom logo to the console and customize the login background image and login panel text. 
...
To display your custom logo image, login background image, and login panel text on the console:
