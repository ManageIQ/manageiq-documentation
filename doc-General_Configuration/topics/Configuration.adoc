...
[NOTE]
====
When you configure database replication in this version of {product-title_short}, centralized administration gets automatically enabled and no further configuration is needed.
====
