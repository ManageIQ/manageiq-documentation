...
. Navigate to menu:Compute[Infrastructure > Virtual Machines], and check the VMware virtual machine you want to rename.
. Click image:1847.png[](*Configuration*), image:1851.png[](*Rename selected item*).
. In the *Basic Information* screen, provide a new *name*.
. Click *Save*.

The remaned virtual machine will appear in the inventory view. 
