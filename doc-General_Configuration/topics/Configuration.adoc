...
For more information on managing subscriptions for an IT infrastructure, see the Red Hat Subscription Management https://access.redhat.com/documentation/en-US/Red_Hat_Subscription_Management/1/html-single/Subscription_Concepts_and_Workflows/index.html[Subscription Concepts and Workflows] guide.
