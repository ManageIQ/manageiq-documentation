...
For more detailed information on managing reports, see https://access.redhat.com/documentation/en/red-hat-cloudforms/4.6-beta/single/monitoring-alerts-and-reporting/[Monitoring, Alerts, and Reporting].
