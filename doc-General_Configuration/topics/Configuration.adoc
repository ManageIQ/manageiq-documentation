...
ifdef::cfme[]
See the section on _Centralized Administration_ in the https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7/html-single/deployment_planning_guide/#central-administration[Deployment Planning Guide] for an overview of the feature.
endif::cfme[]
