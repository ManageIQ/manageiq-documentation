...
[NOTE]
====
You can migrate a single virtual machine to Red Hat Cloud-native Virtualization (technical preview). See link:TBD[].
// https://access.redhat.com/documentation/en-us/openshift_container_platform/4.1/html/container-native_virtualization_users_guide/index#cnv-importing-vm-wizard-web
====
...
* xref:Preparing_the_target_environment[Preparing the Red Hat Virtualization or OpenStack Platform environment]
