...
{product-title} integrates with AWS CloudFormation and OpenStack Heat and provides an ability to:
...
Use this procedure to add new orchestration templates using the dashboard user interface.
