...
. Click  image:1847.png[] btn:[(Configuration)], and then  image:2148.png[] btn:[(Compare Selected)].
  The comparison displays in a compressed view with a limited set of properties listed.
+
image:2149.png[]
+
. To delete an item from the comparison, click  image:1861.png[]btn:[(Remove this from the comparison)] at the bottom of the items column.
