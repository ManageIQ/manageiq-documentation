...
To work around this, create and mount the dedicated database partition manually with exactly same information from the primary database before configuring the standby database appliance as below. [ADD STEPS?]
