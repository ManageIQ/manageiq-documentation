...
[NOTE]
====
For information on managing the inventory available to Amazon Elastic Block Store managers, see https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/managing_infrastructure_and_inventory/#volumes[Volumes] in the _Managing Infrastructure and Inventory_ guide.
====
endif::cfme[]
...
[NOTE]
====
For information on managing the inventory available to OpenStack Block Storage managers, see https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/managing_infrastructure_and_inventory/#volumes[Volumes] in the _Managing Infrastructure and Inventory_ guide.
====
endif::cfme[]
