...
ifdef::cfme[]
See _Centralized Administration_ in the https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.6/html-single/deployment_planning_guide/#central-administration[Deployment Planning Guide] for a complete list of life cycle operations supported by centralized administration and an overview of the feature.
endif::cfme[]
