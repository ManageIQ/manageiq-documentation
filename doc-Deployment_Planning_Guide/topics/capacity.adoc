...
------
+
. Add the configured OpenStack provider to {product-title}. See ifdef::cfme[link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.1/managing-providers/#adding_openstack_providers[Adding OpenStack Providers] in _Managing Providers_.
...
ifdef::cfme[]
For the procedure to view Capacity and Utilization Charts for a Datastore, see section in link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.1/managing-infrastructure-and-inventory/[Viewing Capacity and Utilization Charts for a Datastore] in _Managing Infrastructure and Inventory_.
endif::cfme[]
