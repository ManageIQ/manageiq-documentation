...
link://docs.aws.amazon.com/AWS[AWS documentation] on using VM Import/Export to
...
----
+
. Create an AMI from the snapshot. See the link://docs.aws.amazon.com/AWS[AWS documentation] on
