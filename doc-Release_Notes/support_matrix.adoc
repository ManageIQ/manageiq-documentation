...
See link:https://access.redhat.com/node/1548913[Platform Support Matrix Red Hat CloudForms 4.0/Red Hat CloudForms Management Engine 5.5] for the details of support for the following items:
