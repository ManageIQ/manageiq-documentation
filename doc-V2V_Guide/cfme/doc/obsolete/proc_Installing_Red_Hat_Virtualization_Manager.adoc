...
. Press `Enter` to allow access to a virtual machine's serial console from the command line:
+
[options="nowrap" subs="+quotes,verbatim"]
----
...
After installing the Manager, you can connect to the Administration Portal as the *admin@internal* user.
