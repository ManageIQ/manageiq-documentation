...
If you do not know how to create a condition, see xref:Creating_a_new_Policy_Condition.adoc[Creating a new Policy Condition]. Carefully plan the purpose of your policy before creating it. You can also use a scope expression that is tested immediately when the compliance check event
