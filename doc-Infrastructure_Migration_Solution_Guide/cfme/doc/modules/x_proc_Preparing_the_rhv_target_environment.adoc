...
----
+
Otherwise, SSH will fail for the vdsm user. This issue cannot be resolved by modifying the configuration file because the file is restored during upgrades. See See link:https://bugzilla.redhat.com/show_bug.cgi?id=1544379[].
