...
+
* xref:Questions_to_ask_before_migration[Questions designed to assess the resources and time required for your migration]
...
* xref:Creating_and_running_a_migration_plan[Creating and running a migration plan]. For a detailed description of the migration process, see xref:Vmware_to_rhv_migration_workflow[] or xref:Vmware_to_osp_migration_workflow[].
