...
ifdef::cfme[For more information on #Default Repository# SmartProxy parameter, see link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.7/general-configuration/general-configuration[General Configuration].]
