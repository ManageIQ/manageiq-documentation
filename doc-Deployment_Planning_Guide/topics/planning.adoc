...
{product-title} includes centralized administration capabilities, where certain operations can be initiated from the global region and processed and executed on the remote region. 
...
{product-title_short} life cycle operations other than those listed above are not supported. 
