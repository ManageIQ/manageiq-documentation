// Used in module: assembly_Planning.adoc
...
+
This xref:Migration_example[migration example] is provided as a guide.

include::ref_Migration_example.adoc[leveloffset=+1]
