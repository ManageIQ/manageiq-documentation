...
For more information, see https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/managing_providers/#storage_managers[Storage Managers] from the https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/managing_providers/[Managing Providers] guide.
...
For more information about available options for block storage resources in {product-title_short}, see https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/managing_providers/#openstack_block_storage_managers[OpenStack Block Storage Managers] (from the https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/managing_providers/[Managing Providers] guide).
