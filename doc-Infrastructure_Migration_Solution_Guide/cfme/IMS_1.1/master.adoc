...
|xref:Configuring_conversion_hosts_ansible_vddk_{context}[] |xref:Configuring_the_conversion_hosts_for_ssh_transformation_{context}[].
...
The private key of the SSH key pair that is generated in this step will be used in xref:Configuring_the_conversion_hosts_for_ssh_transformation_{context}[].
|xref:Configuring_conversion_hosts_ansible_vddk_{context}[] |xref:Configuring_conversion_hosts_ansible_ssh_{context}[].
|After xref:Configuring_conversion_hosts_ansible_vddk_{context}[] |xref:Copying_vmware_ssh_keys_to_conversion_hosts-{context}[]
|===
