...
[NOTE]
====
Please note that, outside of the {product-title} user interface, Red Hat Marketing may refer to *Dynamic Resource Objects* when referencing the features and applications of generic objects. 
====
endif::cfme[]
