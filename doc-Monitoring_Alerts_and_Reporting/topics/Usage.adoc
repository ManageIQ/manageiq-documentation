...
ifdef::cfme[See link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.7/managing-infrastructure-and-inventory/#to_tag_virtual_machines_and_templates[Tagging Virtual Machines and Templates] in _Managing Infrastructure and Inventory_.]
...
ifdef::cfme[For more information on configuring capacity and utilization charts, see link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.7/deployment-planning-guide/#Capacity_Planning[Capacity Planning] in the _Deployment Planning Guide_.]
