...
. If you are using SSH transformation, you must configure the VMware hypervisors. See xref:Configuring_the_vmware_hypervisors_for_ssh_transformation_{context}[].
...
If you are using SSH transformation, you must configure the VMware hypervisors. See xref:Preparing_the_vmware_virtual_machines_for_{context}[].
