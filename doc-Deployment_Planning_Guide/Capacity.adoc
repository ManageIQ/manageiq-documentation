...
** In the right pane, under the *C & U Collection* tab, check the boxes for *Collect for All Clusters* under *Clusters* and *Collect for All Datastores* under *Datastores*, or select and check the boxes for the clusters/datastores you desire.
+
[NOTE]
======
