...
* *OpenShift Enterprise*. For information on adding this provider type, see xref:Adding_an_OpenShift_Provider.adoc[Adding an OpenShift Enterprise Provider].
* *Atomic Enterprise Platform*. For information on adding this provider type, see xref:Adding_an_Atomic_Enterprise_Provider.adoc[Adding an Atomic Enterprise Platform Provider].
...
[NOTE]
======
At the moment, the `management-infra-admin` role is needed to address the OpenShift issue link:https://github.com/openshift/origin/issues/5973[#5973].
======
+
