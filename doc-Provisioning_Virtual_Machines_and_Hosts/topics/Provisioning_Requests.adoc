...
* ISO provisioning requires a customization template to provide Kickstart files for initial uploading of the operating system. See xref:customization-templates-for-virtual-machine-and-instance-provisioning[] for more information on customization templates.
* ISO Provisioning on Red Hat Virtualization will write the content generated by the customization template to a file named `ks.cfg` that will be attached to the virtual machine using the RHV floppy payload. If this content is to be included in the installation, the ISO image must be aware of this and include the contents of the file. This requires remastering of the ISO to include a custom Kickstart file. 
...
[NOTE]
====
ISO provisioning is performed using a Kicksart file. The customization template is required to provide Kickstart files for initial uploading of the operating system.
====
...
* The *Kickstart* file in the root directory of the ISO must be named *ks.cfg*.
* ISO Provisioning on Red Hat Virtualization will write the content generated by the customization template to the file named *ks.cfg* that will be attached to the virtual machine using the RHV floppy payload. If this content is to be included in the installation, the ISO image must be aware of this and include the contents of the file. This requires remastering of the ISO to include a custom Kickstart file. 
