...
After enabling the required server roles, enable SmartState analysis. See https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/support_matrix/#smart_state_analysis_support[Smart State Analysis Support] from the Support Matrix and https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/managing_providers/#running-a-smartstate-analysis[Running a SmartState Analysis] in the _Managing Providers_ guide for more information.
