...
ifdef::cfme[For more information, see link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.7-Beta/general-configuration/#profiles[General Configuration].]
