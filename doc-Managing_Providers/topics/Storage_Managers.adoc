...
In {product-title_short}, a storage manager is a service providing storage resources that you can manage from a {product-title_short} appliance.

include::common/openstack/storage-manager-available.adoc[]

This chapter describes the different types of storage managers used by {product-title_short}, and how to manage them.
