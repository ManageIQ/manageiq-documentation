...
NOTE: See https://access.redhat.com/documentation/en/red-hat-cloudforms/4.6-beta/paged/general-configuration in the _General Configuration_ guide, to learn how to verify the address and validate outgoing email settings.
