...
ifdef::cfme[See the link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.1/general-configuration/#configuration[Configuration] chapter in the General Configuration guide for information on how to create analysis profiles.]
