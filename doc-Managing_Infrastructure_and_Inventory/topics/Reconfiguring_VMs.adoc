...
Memory, processors, disks and CD/DVD Drives can be reconfigured on existing VMware and Red Hat Virtualization virtual machines using the *Reconfigure this VM* button.
