...
Red Hat Infrastructure Migration Solution (IMS) 1.3 enables you to migrate virtual machines from VMware{nbsp}6.0 (and later) to  Red Hat Virtualization or Red Hat OpenStack Platform, using Red Hat CloudForms:
