...
Red Hat's Infrastructure Migration Solution (IMS) enables you to migrate virtual machines from VMware 5.5 to Red Hat Virtualization 4.2.7 (or later) or to Red Hat OpenStack Platform 13 (or later):
