...
. Select the *Catalog Item Type* you are adding. Only providers available to the appliance show in this list. The dialogs that appear will be filtered based on the selected type of provider. 
