...
1.  Log in to the console as a user who is assigned either the super administrator or
...
5.  Click on the accordion name you want to organize or add folders to.
      ...
      - Click ![add](../images/add.png) (**Add subfolder to selected folder**) to add a
        folder. When creating a subfolder, be sure to select the folder that you want the
        subfolder to show under. To name the folder, double-click on `New Folder`.
