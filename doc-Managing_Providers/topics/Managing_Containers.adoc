...
[NOTE]
====
To reliably associate pods and images, {product-title_short} requires information from the `docker-pullable` field, added in OpenShift 3.3.1.2. This information is also used in the *Chargeback by Image* report. {product-title_short} may not report accurate information about pods and images in OpenShift providers older than version 3.3.1.2.
====
