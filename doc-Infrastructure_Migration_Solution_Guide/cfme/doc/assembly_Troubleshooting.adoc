...
If errors occur for reasons unrelated to the infrastructure mapping or migration plan (for example, network outage), you can retry the migration plan or remigrate previously migrated virtual machines. See xref:Retrying_and_remigrating[].
