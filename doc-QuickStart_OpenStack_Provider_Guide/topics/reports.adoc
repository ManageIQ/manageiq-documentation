...
For more detailed information on managing reports, see https://access.redhat.com/documentation/en/red-hat-cloudforms/4.7-Beta/single/monitoring-alerts-and-reporting/[Monitoring, Alerts, and Reporting].
