...
For more information, see  https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7/html-single/deployment_planning_guide/#capacity-and-utilization-collection[Capacity and Utilization Collection] in the _Deployment Planning Guide_.
