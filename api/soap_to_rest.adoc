...
| EVMDeleteVmByName            | DELETE | /api/vms/:id              | | link:../api_examples/delete_vm.html[Delete VM]
|                              | POST   | /api/vms/:id              | delete | link:../api_examples/delete_vm.html#deleting-multiple-vms[Delete VMs]
...
|===================================================================
| SOAP API | HTTP Method | REST API URLs | Actions | Examples
| ClusterSetTag                | POST   | /api/clusters/:id/tags | assign | link:../api_reference/tagging.html#assigning-tags[Assigning Tags]
| DatastoreSetTag              | POST   | /api/data_stores/:id/tags | assign | link:../api_reference/tagging.html#assigning-tags[Assigning Tags]
| EmsSetTag                    | POST   | /api/providers/:id/tags | assign | link:../api_reference/tagging.html#assigning-tags[Assigning Tags]
| EVMActionList                | GET    | /api/policies/:id/policy_actions | | link:../api_reference/policy_collections.html#policy-actions[Policy Actions]
|                              | GET    | /api/policies/:id?expand=policy_actions | |
|                              | GET    | /api/policies?filter[]="guid='....'"&expand=resources,policy_actions | |
| EVMAddLifecycleEvent         | POST   | /api/vms/:id | add_lifecycle_event | link:../api_examples/add_lifecycle_event_vm.html[Add Lifecycle Event to VM]
| EVMAssignPolicy              | POST   | /api/hosts/:id/policies | assign | link:../api_reference/policies.html#assigning-policies-to-a-resource[Assigning Policies]
| EVMConditionList             | GET    | /api/policies/:id/conditions | | link:../api_reference/policy_collections.html#policy-conditions[Policy Conditions]
|                              | GET    | /api/policies/:id?expand=conditions | |
|                              | GET    | /api/policies?filter[]="guid='....'"&expand=resources,conditions | |
| EVMEventList                 | GET    | /api/policies/:id/events | | link:../api_reference/policy_collections.html#policy-events[Policy Events]
|                              | GET    | /api/policies/:id?expand=events | |
|                              | GET    | /api/policies?filter[]="guid='....'"&expand=resources,events | |
| EVMGetPolicy                 | GET    | /api/policies | | link:../api_reference/policies.html#querying-policies[Querying Policies]
|                              | GET    | /api/policies/:id | | 
|                              | GET    | /api/policies?filter[]="name='....'" | | 
| EVMPolicyList                | GET    | /api/hosts/:id/policies | | link:../api_reference/policies.html[Policy Management]
|                              | GET    | /api/hosts/:id?expand=policies | | 
|                              | GET    | /api/hosts?filter[]="guid='....'"&expand=resources,policies | | 
| EVMVmEventByProperty         | POST   | /api/vms/:id | add_event | link:../api_examples/add_event_vm.html[Add VM Event]
| EVMVmScanByProperty          | POST   | /api/vms/:id | scan | link:../api_examples/scan_vm.html[Scan VM]
| EVMSmartStart                | POST   | /api/vms/:id | start | link:../api_examples/start_vm.html[Start VM]
| EVMSmartStop                 | POST   | /api/vms/:id | stop | link:../api_examples/stop_vm.html[Stop VM]
| EVMSmartSuspend              | POST   | /api/vms/:id | suspend | link:../api_examples/suspend_vm.html[Suspend VM]
| EVMUnassignPolicy            | POST   | /api/hosts/:id/policies | unassign | link:../api_reference/policies.html#unassigning-policies-from-a-resource[Unassigning Policies]
| EVMVmRsop                    | POST   | /api/vms/:id/policies/:id | resolve | link:../api_reference/policies.html#resolving-policies-of-a-resource[Resolving Policies]
|                              | POST   | /api/vms/:id/policy_profiles/:id | resolve | link:../api_reference/policies.html#resolving-policy-profiles-of-a-resource[Resolving Policy Profiles]
| HostSetTag                   | POST   | /api/hosts/:id/tags | assign | link:../api_reference/tagging.html#assigning-tags[Assigning Tags]
| ResourcePoolSetTag           | POST   | /api/resource_pools/:id/tags | assign | link:../api_reference/tagging.html#assigning-tags[Assigning Tags]
| VmAddCustomAttribute         | POST   | /api/vms/:id/custom_attributes | add | link:../api_reference/custom_attributes.html#add-custom-attributes[Adding Custom Attributes]
...
| VmDeleteCustomAttribute      | POST   | /api/vms/:id/custom_attributes | delete | link:../api_reference/custom_attributes.html#delete-custom-attributes[Deleting Custom Attributes]
| VmDeleteCustomAttributes     | POST   | /api/vms/:id/custom_attributes | delete | 
| VmSetTag                     | POST   | /api/vms/:id/tags | assign | link:../api_reference/tagging.html#assigning-tags[Assigning Tags]
| VmSetOwner                   | POST   | /api/vms/:id | set_owner | link:../api_examples/set_owner_vm.html[Set Owner of VM]
|===================================================================
...
|===================================================================
| SOAP API | HTTP Method | REST API URLs | Actions | Examples
| CreateAutomationRequest      | POST   | /api/automation_requests | create | link:../api_examples/automation_request.html[Create Automation Request],
link:../api_examples/automation_requests.html[Create Automation Requests]
| EVMProvisionRequestEx        | POST   | /api/provision_requests | create | link:../api_examples/provision_request.html[Create Provision Request],
link:../api_examples/provision_requests.html[Create Provision Requests]
...
| VmProvisionRequest           | POST   | /api/provision_requests | create | link:../api_examples/provision_request.html[Create Provision Request],
link:../api_examples/provision_requests.html[Create Provision Requests]
|===================================================================
