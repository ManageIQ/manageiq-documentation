...
For information on configuring database failover in VMDB appliances, see the https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html-single/high_availability_guide/[_High Availability Guide_].
endif::cfme[]
