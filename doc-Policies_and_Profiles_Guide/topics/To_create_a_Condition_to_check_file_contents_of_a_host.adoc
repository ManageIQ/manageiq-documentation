...
ifdef::cfme[See link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.5/managing-infrastructure-and-inventory/#sect_hosts[Hosts] in _Managing Infrastructure and Inventory_ for instructions.]
