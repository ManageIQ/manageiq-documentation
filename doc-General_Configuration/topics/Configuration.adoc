...
image:2071.png[]
. In *Custom Logo Image (Shown on top right of all screens)*, click *Browse* to go to the location where the logo file is located.
...
. Click on the server.
. Click the *Custom Logos* tab.
. In *Custom Login Background Image*, click *Browse* to go to the location where the logo file is located.
+
image:2073.png[]
+
. Click *Upload*. The icon is displayed above the file name box, and an option is shown to use the logo.
. Check *Use Custom Login Image* to add the background image to the login screen of the user interface.
. Click *Save*.
...
image:2075.png[]
. Click *Use Custom Login Text* to switch it to `ON`.
. Click *Save*.
