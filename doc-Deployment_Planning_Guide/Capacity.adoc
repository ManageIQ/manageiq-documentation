...
** For Red Hat Enterprise Linux OpenStack Platform: link:https://access.redhat.com/documentation/en/red-hat-cloudforms/version-4.0/deployment-planning-guide/#data_collection_for_red_hat_enterprise_linux_openstack_platform[Data Collection for Red Hat Enterprise Linux OpenStack Platform]
