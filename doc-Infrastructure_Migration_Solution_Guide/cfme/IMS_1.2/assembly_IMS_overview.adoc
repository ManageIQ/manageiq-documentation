...
* xref:Configuring_the_conversion_hosts[Configuring the conversion hosts in CloudForms]. Conversion hosts are RHV hosts or Red Hat OpenStack Platform instances running `virt-v2v` and `virt-v2v-wrapper`, which perform the migration.
