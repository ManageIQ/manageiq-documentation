...
. Installing and configuring CloudForms 4.7.0. See xref:Installing_cf_4_7_0_with_rhv[].
...
. Installing and configuring CloudForms 4.7.0. See xref:Installing_cf_4_7_0_with_osp[].
