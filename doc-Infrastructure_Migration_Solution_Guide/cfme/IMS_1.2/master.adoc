...
Red Hat Infrastructure Migration Solution (IMS) 1.2 enables you to migrate virtual machines from VMware{nbsp}6.0 (or later) to Red Hat Virtualization or Red Hat OpenStack Platform, using Red Hat CloudForms.
...
The private key of the SSH key pair that is generated in this step will be used in xref:Configuring_conversion_hosts_cloudforms_rhv_1-2_ssh[Configuring the RHV conversion hosts for SSH transformation].
...
|Instead of xref:Configuring_conversion_hosts_cloudforms_rhv_1-2_vddk[Configuring the RHV conversion hosts for VDDK transformation] <a|Go to:

* xref:Configuring_conversion_hosts_cloudforms_rhv_1-2_ssh[Configuring the RHV conversion hosts for SSH transformation]
...
The private key of the SSH key pair that is generated in this step will be used in xref:Configuring_conversion_hosts_cloudforms_osp_1-2_ssh[Configuring the RHOSP conversion hosts for SSH transformation].

|Instead of xref:Configuring_conversion_hosts_cloudforms_osp_1-2_vddk[Configuring the RHOSP conversion hosts for VDDK transformation] <a|Go to:

* xref:Configuring_conversion_hosts_cloudforms_osp_1-2_ssh[Configuring the RHOSP conversion hosts for SSH transformation]
* xref:Copying_vmware_ssh_keys_to_conversion_hosts_osp_1-2_ssh[Copying the VMware SSH keys to the RHOSP conversion hosts]
|===
