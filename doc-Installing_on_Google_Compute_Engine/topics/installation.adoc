...
.. Click image:GCE-ManagementSSHkeys.png[]*Management, disk, networking, SSH keys*. Click the *SSH Keys* tab, add your entire SSH public key data in the *Username* box.
