...
. Navigate to menu:Compute[Containers > Providers].
. Choose the desired containers provider for viewing the provider summary.
. Click on *Projects* on the summary page. 
. Select the desired project.
. On the projects summary page, click the topology view button. 

==== Limiting the Number of Containers Shown in the Topology View
. Navigate to menu:Configuration[My Settings] and click on the *Visual* tab.
