...
. xref:Downloading_the_conversion_host_appliance[Download the latest conversion host appliance].
. xref:Deploying_osp_conversion_hosts[Re-deploy the conversion hosts].
====
