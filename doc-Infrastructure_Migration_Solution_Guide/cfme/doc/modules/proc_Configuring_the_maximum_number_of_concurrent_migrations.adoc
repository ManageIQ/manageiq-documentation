...
Questions - Does SSH with a later RHV version have another limit?

Is the user no longer able to set maximum number of current migrations for a provider? Or do we provide the rails console command?
