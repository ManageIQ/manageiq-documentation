...
To successfully deploy a {product-title} appliance on OpenShift Container Platform, you need a functioning *OpenShift Container Platform 3.7* or newer install with the following configured:
...
StatefulSets in OpenShift allow scaling of {product-title_short} appliances. 
