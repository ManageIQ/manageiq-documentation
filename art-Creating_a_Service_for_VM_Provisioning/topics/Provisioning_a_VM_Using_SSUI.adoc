...
Also, see the link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html-single/self_service_user_interface_guide/[Self Service User Interface Guide] for more information about using the Self Service user interface.
