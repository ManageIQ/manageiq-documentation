...
* For more information about control and compliance policies, and creating and assigning policy profiles in {product-title_short}, see the link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.6/html-single/policies_and_profiles_guide/[Policies and Profiles Guide].
====
