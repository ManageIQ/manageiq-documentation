...
You can also configure centralized administration via database replication settings described in this section. Once configured, {product-title} supports life cycle management operations that can be initiated from the global copy and processed and executed on the remote copy. 
...
Database replication and centralized administration is now configured to support life cycle management operations that can be initiated from the global copy and processed and executed on the remote copy.
