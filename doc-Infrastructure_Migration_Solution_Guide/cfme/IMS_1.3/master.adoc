...
Red Hat Infrastructure Migration Solution (IMS) 1.3 enables you to migrate virtual machines from VMware{nbsp}5.5 (and later) to  Red Hat Virtualization or Red Hat OpenStack Platform, using Red Hat CloudForms:
...
include::modules/ref_Recommendations_for_migration_1_3.adoc[leveloffset=+2]
...
. Preparing the target environment. See xref:Preparing_the_1_3_{context}_environment[].
...
include::modules/proc_Preparing_the_vmware_network_1_3.adoc[leveloffset=+3]
...
include::assembly_Preparing_the_1_3_target_environment.adoc[leveloffset=+2]
