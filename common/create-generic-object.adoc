...
Model a new resource by creating a generic object class and add it to your {product-title} inventory. Each generic object class can have attributes, associations, and methods. Once created through Automate, generic objects are visible to users of the service UI at the resource level.  
