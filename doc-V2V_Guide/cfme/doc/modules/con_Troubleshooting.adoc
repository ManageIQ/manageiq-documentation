...
* Virtual machine migration log: You can download the migration log for each virtual machine by clicking the migration plan to go to the migration plan details, and clicking `Download Log`.
