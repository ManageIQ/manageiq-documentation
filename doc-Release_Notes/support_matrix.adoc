...
See link:https://access.redhat.com/articles/1480063[Platform Support Matrix Red Hat CloudForms 4.0/Red Hat CloudForms
Management Engine 5.5] for the details of support for the following items:
