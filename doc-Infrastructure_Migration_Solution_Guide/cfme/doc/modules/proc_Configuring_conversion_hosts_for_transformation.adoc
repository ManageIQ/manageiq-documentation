...
. Verifying the conversion host configuration with the `conversion_host_check` playbook
...
. In the *Default* tab of the Endpoints section, enter `root` as the *Username* and the *Password*.
