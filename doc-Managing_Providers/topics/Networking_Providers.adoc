...
ifdef::cfme[See https://access.redhat.com/documentation/en/red-hat-cloudforms/4.6-beta/policies-and-profiles-guide/#assigning_policy_profiles_to_a_network_provider[Assigning Policy Profiles to a Network Provider] and https://access.redhat.com/documentation/en/red-hat-cloudforms/4.6-beta/policies-and-profiles-guide/#removing_policy_profiles_from_a_network_provider[Removing Policy Profiles from a Network Provider] in the _Policies and Profiles Guide_.]
