...
[NOTE]
====
In addition to setting the server role, you must also select which clusters and datastores to collect data for. For more information, see _General Configuration_. You must have super administrator rights to edit these settings.
====
...
----
+
. Enable external md5 authentication. Change the authentication method from `ident` to `md5` in the following line in `/var/lib/pgsql/data/pg_hba.conf`:
+
----
host    all      all    0.0.0.0/0     md5
----
+
. Enable PostgreSQL to listen for remote connections. Update the `listen_addresses` line in `/var/lib/pgsql/data/postgresql.conf`:
+
----
listen_addresses  =  '*'
----
...
ifdef::cfme[link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.2/html-single/managing_providers/#adding_openstack_cloud_providers[Adding OpenStack Providers] in _Managing Providers_.]
...
Once enabled, it may take a few minutes to propagate to {product-title_short}.
...
* link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.2/html-single/managing_infrastructure_and_inventory/#viewing_capacity_and_utilization_charts_for_a_host[Viewing Capacity and Utilization Charts for a Host]
* link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.2/html-single/managing_infrastructure_and_inventory/#viewing_capacity_and_utilization_charts_for_a_cluster[Viewing Capacity and Utilization Charts for a Cluster]
* link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.2/html-single/managing_infrastructure_and_inventory/#to_view_capacity_and_utilization_charts_for_a_virtual_machine[Viewing Capacity and Utilization Charts for a
Virtual Machine]
endif::cfme[]
...
ifdef::cfme[]
See link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.2/html-single/managing_infrastructure_and_inventory/#viewing_capacity_and_utilization_charts_for_a_datastore[Viewing Capacity and Utilization Charts for a Datastore] in _Managing Infrastructure and Inventory_ for more information.
endif::cfme[]

[[chart-features]]
=== Capacity and Utilization Chart Features

Capacity and utilization charts for hosts, clusters, virtual machines, and datastores provides its own set of special features including zooming in on a chart and shortcut menus.
...
[NOTE]
====
For information about utilization trends and identifying bottlenecks in your environment, see link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.2/html-single/managing_infrastructure_and_inventory/#data-optimization[Data Optimization] in _Managing Infrastructure and Inventory_.
====
endif::cfme[]
