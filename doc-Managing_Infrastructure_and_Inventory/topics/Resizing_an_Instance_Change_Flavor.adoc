...
For more information about the requirements and underlying OpenStack process involved, see https://access.redhat.com/documentation/en/red-hat-openstack-platform/8/single/instances-and-images-guide/#section-resize-instance[Resize an Instance] from the Red Hat OpenStack Platform _Instances and Images Guide_.
====
...
See xref:flavors[] and https://access.redhat.com/documentation/en/red-hat-openstack-platform/8/single/instances-and-images-guide/#section-flavors[Manage Flavors] (from the Red Hat OpenStack Platform _Instances and Images Guide_) for more information.
