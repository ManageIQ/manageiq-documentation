...
There is now the option to perform most of these tasks in bulk (except editing service details and power operations). In order to do so, select the services and then click the designated button for the required task on the upper-left corner of the screen. 
...
. From the *Services* screen, click on more options next to the service you want set ownership for, then click *Set Ownership*.
. Alternatively, click on the service. Click the image:ssui-service-settings-button.png[] button located on the upper-right corner of the screen, then select *Set Ownership*.
...
. From the *Services* screen, click on more options next to the service you want add or edit tags for, then click *Edit Tags*.
. Alternatively, click on the service. Click the image:ssui-edit-tags-button.png[] button located on the upper-right corner of the screen, then select *Edit Tags*.
...
. From the *Services* screen, click on more options next to the service you want to remove, then click *Remove*.
. Alternatively, click on the service. Click the image:ssui-service-settings-button.png[] button located on the upper-right corner of the screen, then select *Remove*. A confirmation window appears.
...
. From the *Services* screen, click on more options next to the service you want to remove, then click *Edit*.
. Alternatively, click on the service. Click the image:ssui-service-settings-button.png[] button located on the upper-right corner of the screen, then select *Edit*. An *Edit Service* screen appears.
...
{product-title} full administrative user interface and the Self Service user interface have enabled for users to access the Cockpit interface for a given virtual machine. 
...
The option to open the Cockpit console for a virtual machine is available in the image:ssui-access-button.png[Access Button] button, which also houses the option to open HTML5 Console, in the *Resources* section inside the *Services* tab. 
