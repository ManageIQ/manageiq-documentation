...
ifdef::cfme[]
For procedures to view capacity and utilization charts for hosts, clusters, and virtual machines, see the following sections in _Managing Infrastructure and Inventory_, as well as see link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html/managing_infrastructure_and_inventory/#capacity-utilization-features[Capacity and Utilization Data Features] for information about chart features and other trend reports.
...
* See link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.5/html/managing_infrastructure_and_inventory/#capacity-utilization-features[Capacity and Utilization Data Features] in _Managing Infrastructure and Inventory_ for information about chart features and other trend reports.
endif::cfme[]
