...
+
* To authenticate to Red Hat Enterprise Virtualization hosts see xref:authenticating_rhev_hosts[Authenticating Red Hat Enterprise Virtualization Hosts]. 
* To authenticate to VMware vCenter hosts see xref:authenticating_vmware_hosts[Authenticating VMware vCenter Hosts]. 
