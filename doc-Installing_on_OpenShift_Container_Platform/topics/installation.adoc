...
These template files, and others, are available in OpenShift 3.7. They can also be found in GitHub at: https://github.com/openshift/openshift-ansible/tree/master/roles/openshift_examples/files/examples/v3.7/cfme-templates
...
/////
OpenShift Container Platform 3.5 includes these files by default. Does 3.7?
/////
