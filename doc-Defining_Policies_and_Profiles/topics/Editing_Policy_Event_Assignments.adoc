...
. Check all the events you want to assign to this policy. For a description of the events, see link:https://access.redhat.com/documentation/en/red-hat-cloudforms/version-4.0/defining-policies-and-profiles/#chap_events[Events].
