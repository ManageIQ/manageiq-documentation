...
{solution-title} 1.2 enables you to migrate virtual machines from VMware{nbsp}6.0, or later, to Red Hat Virtualization or Red Hat OpenStack Platform, using Red Hat CloudForms.
