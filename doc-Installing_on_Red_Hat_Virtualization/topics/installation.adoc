...
. Click *Attach*.
. Select the {product-title_short} appliance you just uploaded from the list of images and click *OK*.
...
. To start the {product-title_short} appliance, select the virtual machine from the *Virtual Machines* tab and click *Run*. 
