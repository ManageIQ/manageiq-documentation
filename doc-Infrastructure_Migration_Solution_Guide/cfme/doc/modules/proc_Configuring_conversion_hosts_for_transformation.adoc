...
* If you are configuring your OpenStack Platform conversion host for SSH, you can xref:Configuring_ssh_connection_osp[configure the SSH connection to the VMware hypervisors].
...
* If you are configuring your RHV conversion host for SSH, you can xref:Configuring_ssh_connection_rhv[configure the SSH connection to the VMware hypervisors].
