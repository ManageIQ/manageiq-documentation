...
To send emails from the CloudForms Management Engine server, you must have the notifier server role enabled and have defined settings for SMTP email. For further information regarding SMTP, see the link:https://access.redhat.com/documentation/en/red-hat-{product-title}/4.1/general-configuration/general-configuration[General Configuration]
guide.
