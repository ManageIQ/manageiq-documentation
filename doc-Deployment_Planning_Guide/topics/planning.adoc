...
ifdef::cfme[]
For more information, see [https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.2/single/configuring_high_availability/index[Configuring High Availability]. 
endif::cfme[]
====
