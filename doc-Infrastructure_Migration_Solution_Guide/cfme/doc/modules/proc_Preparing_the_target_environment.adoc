...
[NOTE]
====
If you upgrade the target environment, you should also xref:Upgrading_the_conversion_hosts[upgrade the conversion hosts] to ensure that you have the latest software and patches.
====
