...
Red Hat OpenStack Platform provides a scaleable, fault-tolerant, private or public cloud based on Red Hat Enterprise Linux. See link:https://access.redhat.com/documentation/en-us/red_hat_openstack_platform[Red Hat OpenStack Platform] documentation for more information.
+
See xref:Migrating_from_vmware_to_osp_1-3_vddk[].

Red Hat CloudForms 5.0::
Red Hat CloudForms is the environment in which you perform the migration. Red Hat CloudForms is a unified set of management tools for use across virtualized, private cloud, and public cloud platforms. See link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/5.0[Red Hat CloudForms 5.0] documentation for more information.
...
The private key of the SSH key pair that is generated in this step will be used in xref:Configuring_conversion_hosts_cloudforms_rhv_1-3_ssh[Configuring the conversion hosts for SSH transformation].
...
|Instead of xref:Configuring_conversion_hosts_cloudforms_rhv_1-3_vddk[Configuring the conversion hosts for VDDK transformation] <a|Go to:

* xref:Configuring_conversion_hosts_cloudforms_rhv_1-3_ssh[Configuring the conversion hosts for SSH transformation]
...
The private key of the SSH key pair that is generated in this step will be used in xref:Configuring_conversion_hosts_cloudforms_osp_1-3_ssh[Configuring the conversion hosts for SSH transformation].

|Instead of xref:Configuring_conversion_hosts_cloudforms_osp_1-3_vddk[Configuring the conversion hosts for VDDK transformation] <a|Go to:

* xref:Configuring_conversion_hosts_cloudforms_osp_1-3_ssh[Configuring the conversion hosts for SSH transformation]
* xref:Copying_vmware_ssh_keys_to_conversion_hosts_osp_1-3_ssh[Copying the VMware SSH keys to the conversion hosts]
|===
