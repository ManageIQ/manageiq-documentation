...
* See xref:Questions_to_ask_before_migration_{context}[] for questions to consider, including the following:

** "How long will the migration take?"
** "How many conversion hosts do I need?"
** "Should I migrate my virtual machines using VDDK or SSH transformation?"

* See xref:Recommendations_for_migration_{context}[] for guidelines on the following topics:
