...
This rich set of information enables CloudForms Management Engine users to improve problem resolution times and effectively manage virtual machines. 

The [label]#Virtual Machines# pages display all virtual machines that were discovered by your Server.
Note that if you have applied a filter to a user, it will be in effect here.
The [label]#Virtual Machines# taskbar is a menu driven set of buttons that provide access to functions related to virtual machines. 
...
The console uses [label]#Virtual Thumbnails# to describe virtual machines and templates.
...
The [label]#Virtual Machines# page has three accordions organizing your virtual machines and templates in different ways.
All of these accordions share a set of common controls 

* Use [label]#VMs and Templates# to view your virtual machines and templates organized by Provider.
  In addition, you can see archived and orphaned items here. 
* Use the [label]#VMs# to view, apply filters, and collect information about all of your virtual machines. 
* Use [label]#Templates# to view, apply filters, and collect information about all of your templates. 
...
The [label]#Virtual Machine Filter# accordion is provided so that you can easily navigate through groups of virtual machines.
You can use the ones provided or create your own through [label]#Advanced Filtering# capabilities. 

.Procedure: To Use a Virtual Machine Or Template Filter
. Navigate to menu:Infrastructure[Virtual Machines]. 
. Go to the [label]#VMs# or [label]#Templates# accordion. 
. Click on the desired filter from the left pane. 

:leveloffset: 3
include::topics/To_create_a_Virtual_Machine_or_Template_Filter.adoc[]


:leveloffset: 3
include::topics/To_load_a_report_filter_or_search_expression.adoc[]


:leveloffset: 2
include::topics/Changing_Views.adoc[]


:leveloffset: 2
include::topics/Sorting_Virtual_Machines_and_Templates.adoc[]


:leveloffset: 2
include::topics/Creating_a_Virtual_Machine_or_Template_Report.adoc[]


:leveloffset: 2
include::topics/Searching_by_Virtual_Machine_or_Template_Name.adoc[]
...
If CloudForms Management Engine is not set up for automatic analysis, perform a manual analysis of a virtual machine.
To perform a SmartState analysis, CloudForms Management Engine requires a running SmartProxy with visibility to the virtual machine's storage location.
...
.Procedure: To Analyze Multiple Virtual Machines or Templates
. Navigate to menu:Infrastructure[Virtual Machines]. 
. Click the accordion for the items to analyze. 
. Check the [label]#Virtual Machines# and [label]#Templates# to analyze. 
...
:leveloffset: 4
include::topics/Storage_Support_Notes_about_Analyzing_from_RHEVM_3.1.adoc[]


:leveloffset: 4
include::topics/Storage_Support_Notes_about_Analyzing_from_RHEVM_3.0.adoc[]
...
:leveloffset: 4
include::topics/Installing_VMware_VDDK_on_CloudForms_Management_Engine.adoc[]

:leveloffset: 2
[[_sect_comparing_virtual_machines_and_templates]]
= Comparing Virtual Machines and Templates

The CloudForms Management Engine Server allows you to compare multiple virtual machines.
...
.Procedure: To Compare Virtual Machines and Templates
. Navigate to menu:Infrastructure[Virtual Machines]. 
. Click the accordion for the items to analyze. 
. Check the items to compare 
. Click  image:images/1847.png[] btn:[(Configuration)], and then  image:images/2148.png[] btn:[(Compare Selected)].
  The comparison displays in a compressed view with a limited set of properties listed. 
+

image::images/2149.png[]

. To delete an item from the comparison, click  image:images/1861.png[]btn:[(Remove this from the comparison)] at the bottom of the items column.
...
:leveloffset: 3
include::topics/Virtual_Machine_and_Templates_Comparison_Sections.adoc[]


:leveloffset: 3
include::topics/To_use_Comparison_Sections.adoc[]


:leveloffset: 3
include::topics/To_create_a_comparison_report.adoc[]


:leveloffset: 2
include::topics/Refreshing_Virtual_Machines_and_Templates.adoc[]


:leveloffset: 2
include::topics/Extracting_Running_Processes.adoc[]


:leveloffset: 2
include::topics/To_set_ownership.adoc[]


:leveloffset: 2
include::topics/Removing_Virtual_Machines_and_Templates_from_the_VMDB.adoc[]


:leveloffset: 2
include::topics/To_tag_Virtual_Machines_and_Templates.adoc[]


:leveloffset: 2
include::topics/To_view_running_processes_after_collection.adoc[]


:leveloffset: 2
include::topics/To_edit_Virtual_Machine_or_Template_Properties.adoc[]


:leveloffset: 2
include::topics/Setting_Ownership_of_a_Virtual_Machine_or_Template.adoc[]


:leveloffset: 2
include::topics/To_right-size_a_Virtual_Machine.adoc[]


:leveloffset: 2
include::topics/To_view_capacity_and_utilization_charts_for_a_Virtual_Machine.adoc[]


:leveloffset: 2
include::topics/To_view_the_timeline_for_a_Virtual_Machine_or_Template.adoc[]


:leveloffset: 2
include::topics/Virtual_Machine_or_Template_Summary.adoc[]


:leveloffset: 2
include::topics/Viewing_the_Operating_System_Properties.adoc[]


:leveloffset: 2
include::topics/Viewing_Virtual_Machine_or_Template_Snapshot_Information.adoc[]


:leveloffset: 2
include::topics/To_view_a_users_group_memberships.adoc[]


:leveloffset: 2
include::topics/To_view_a_groups_members.adoc[]


:leveloffset: 2
include::topics/Viewing_Genealogy_of_a_Virtual_Machine_or_Template.adoc[]


:leveloffset: 2
include::topics/To_view_and_compare_genealogy.adoc[]


:leveloffset: 2
include::topics/To_tag_Virtual_Machines_or_Templates_with_a_common_genealogy.adoc[]


:leveloffset: 2
include::topics/Viewing_Drift_on_Virtual_Machines_or_Templates.adoc[]


:leveloffset: 2
include::topics/To_create_a_drift_report.adoc[]


:leveloffset: 2
include::topics/To_view_analysis_history.adoc[]


:leveloffset: 2
include::topics/To_view_disk_information.adoc[]


:leveloffset: 2
include::topics/To_view_event_logs.adoc[]
