...
ifdef::cfme[link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.5/managing-providers/#adding_openstack_providers[Adding OpenStack Providers] in _Managing Providers_.]
...
* link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.5/managing-infrastructure-and-inventory/#viewing_capacity_and_utilization_charts_for_a_host[Viewing Capacity and Utilization Charts for a Host]
* link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.5/managing-infrastructure-and-inventory/#viewing_capacity_and_utilization_charts_for_a_cluster[Viewing Capacity and Utilization Charts for a Cluster]
* link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.5/managing-infrastructure-and-inventory/#to_view_capacity_and_utilization_charts_for_a_virtual_machine[Viewing Capacity and Utilization Charts for a
Virtual Machine]
endif::cfme[]
...
ifdef::cfme[]
See link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.5/managing-infrastructure-and-inventory/[Viewing Capacity and Utilization Charts for a Datastore] in _Managing Infrastructure and Inventory_ for more information.
endif::cfme[]
