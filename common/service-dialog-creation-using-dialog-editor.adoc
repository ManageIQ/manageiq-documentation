...
.. Click *Save*.
. Repeat the above step to add more elements to the section, or create and add them to a new section as required.
. Repeat the step to add a new tab to the dialog, and any substeps as required.
