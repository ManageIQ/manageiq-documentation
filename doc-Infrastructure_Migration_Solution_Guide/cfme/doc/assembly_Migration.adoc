...
The migration phase has 2 main tasks:

* xref:Creating_an_Infrastructure_Mapping[Mapping the resources] (clusters, datastores, and networks) of your source environment to your target environment
