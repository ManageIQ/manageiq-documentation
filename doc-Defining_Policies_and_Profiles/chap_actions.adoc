...
Actions are performed after the condition is evaluated. CloudForms
Management Engine Control comes with a set of default actions that you
can choose from. You can also create some of your own.
...
|Generate log message |Write an entry to the CloudForms Management
Engine log.
...
|Invoke a Custom Automation |For use with CloudForms Management Engine
...
|Raise Automation Event |Used with CloudForms Management Engine
automate.
...
|Show EVM Event on Timeline |To show the EVM event on the CloudForms
Management Engine timeline.
...
You can create a custom action using the CloudForms Management Engine
...
include::topics/To_create_an_Assign_Profile_to_Analysis_Task_action.adoc[]

include::topics/To_create_a_snapshot_Action.adoc[]

include::topics/To_delete_snapshots_by_age.adoc[]

include::topics/To_evaluate_an_Alert.adoc[]

include::topics/To_create_an_Inherit_Tag_Action.adoc[]

include::topics/To_create_a_CPU_reconfigure_Action.adoc[]

include::topics/To_create_a_memory_reconfigure_Action.adoc[]

include::topics/To_create_an_Remove_Tag_Action.adoc[]

include::topics/To_create_an_e-mail_Action.adoc[]

include::topics/To_create_an_SNMP_Action.adoc[]

include::topics/To_create_a_set_custom_attribute_Action.adoc[]

include::topics/To_create_a_tag_Action.adoc[]

include::topics/Editing_an_Action.adoc[]

include::topics/Deleting_an_Action.adoc[]
