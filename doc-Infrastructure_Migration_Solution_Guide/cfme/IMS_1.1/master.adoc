...
You can install and configure Red Hat Virtualization (RHV) and CloudForms.
...
You can configure the Red Hat Virtualization (RHV) conversion hosts to use the VMware Virtual Disk Development Kit (VDDK) with Ansible playbooks.
...
You can configure the Red Hat OpenStack Platform (RHOSP) conversion hosts to use the VMware Virtual Disk Development Kit (VDDK) with Ansible playbooks.
