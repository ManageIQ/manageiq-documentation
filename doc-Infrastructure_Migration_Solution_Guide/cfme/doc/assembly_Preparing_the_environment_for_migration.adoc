...
. xref:Configuring_conversion_hosts_for_transformation[Configuring the conversion hosts for VDDK or SSH]
+
...
include::modules/proc_Verifying_conversion_hosts.adoc[leveloffset=+2]
