...
ifdef::cfme[See link:https://access.redhat.com/documentation/en/red-hat-cloudforms/4.7-Beta/general-configuration/#configuration[Configuration] in _General Configuration_ for information on how to create analysis profiles.]
