...
[IMPORTANT]
====
Ensure that you download the latest version of the appliance because it contains patches and fixes. The Red Hat OpenStack Platform 14 conversion appliance can be used with both Red Hat OpenStack Platform 13 and 14.
====
