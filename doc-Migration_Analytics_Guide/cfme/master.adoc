...
include::modules/Scanning-vms-for-migration-analytics.adoc[leveloffset=+1]
include::modules/Collecting-inventory-data.adoc[leveloffset=+1]
include::modules/Creating-migration-analytics-reports.adoc[leveloffset=+1]
