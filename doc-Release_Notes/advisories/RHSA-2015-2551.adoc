...
With this release, code was added to only allow Smart State Analysis for VMware storage records in the web user interface. As a result, the SSA button now only shows when using a VMware datastore.
------
