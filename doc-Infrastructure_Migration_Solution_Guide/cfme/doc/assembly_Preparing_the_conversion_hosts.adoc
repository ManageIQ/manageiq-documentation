...
= Preparing the conversion hosts

Before you create the conversion hosts, you must decide xref:Number_of_conversion_hosts[how many conversion hosts] to create and which transformation option (xref:datapath_transformation_options_vddk_ssh[VDDK or SSH]) to use.
