...
:leveloffset: 2
include::Instance_and_Image_Taskbars.adoc[]


:leveloffset: 2
include::Performing_SmartState_Analysis_on_an_Instance_or_Image.adoc[]
...
:leveloffset: 2
include::Changing_the_Summary_View_of_an_Instance_or_Image.adoc[]


:leveloffset: 2
include::Viewing_the_Operating_System_Properties1.adoc[]
