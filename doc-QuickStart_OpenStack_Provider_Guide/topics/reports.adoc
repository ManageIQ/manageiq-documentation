...
The categories of predefined reports available on CloudForms are:

include::common/reports-categories.adoc[]

For more detailed information on managing reports, see https://access.redhat.com/documentation/en/red-hat-cloudforms/4.2/single/monitoring-alerts-and-reporting/[Monitoring, Alerts, and Reporting].
