...
The following procedure demonstrates creating a flavor with the minimum requirements (4 cores, 8GB RAM, 44GB disk space) for {product-title}. For more information about flavors, see the Red Hat OpenStack Platform Administration User Guide.
