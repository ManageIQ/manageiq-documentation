...
The migration phase comprises 2 tasks:
...
* Creating a xref:Creating_and_running_a_migration_plan[migration plan] with optional xref:Automating_pre_and_post_migration_tasks_with_ansible[automated tasks] to run before or after each virtual machine is migrated
