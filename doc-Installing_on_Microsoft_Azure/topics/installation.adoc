...
$ qemu-img convert -f vpc -O raw cfme-azure-5.9.0.17-1.x86_64.vhd cfme-azure-5.9.0.17-1.x86_64.raw
----
+
...
----
#!/bin/bash
rawdisk="cfme-azure-5.9.0.17-1.x86_64.raw"
MB=$((1024 * 1024))
...
$ qemu-img resize -f raw cfme-azure-5.9.0.17-1.x86_64.raw 34361835520
...
qemu-img convert -f raw -o subformat=fixed,force_size -O vpc cfme-azure-5.9.0.17-1.x86_64.raw cfme-azure-5.9.0.17-1.x86_64.vhd
----
+
...
$ qemu-img info --output=json -f vpc cfme-azure-5.9.0.17-1.x86_64.vhd

{
  "virtual-size": 34361835520,
  "filename": "cfme-azure-5.9.0.17-1.x86_64.vhd",
  "format": "vpc",
