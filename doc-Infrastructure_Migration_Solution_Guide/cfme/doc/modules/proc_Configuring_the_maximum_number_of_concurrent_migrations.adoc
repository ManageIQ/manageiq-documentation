...
The maximum supported number of concurrent migrations for conversion hosts is `20` for VDDK and `20` for SSH transformation (for Red Hat Virtualization, the SSH limitation only applies to RHV 4.2.5 and earlier).
