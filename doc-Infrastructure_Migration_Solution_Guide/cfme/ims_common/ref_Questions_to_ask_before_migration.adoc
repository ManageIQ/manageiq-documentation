...
* For a list of operating systems that you can migrate, see link:https://access.redhat.com/articles/973163[Certified Guest Operating Systems in Red Hat OpenStack Platform and Red Hat Virtualization].
...
+
Conversion hosts and providers are limited to ten concurrent migrations, unless you change the default maximum number of concurrent migrations.
+
...
.<a|* Slower than VDDK
* Requires you to enable SSH access for the VMware hypervisors
* Requires you to share SSH keys between the VMware hypervisors and the conversion hosts
|===
