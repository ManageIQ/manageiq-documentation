...
[IMPORTANT]
====
Enabling external authentication must be done from the {product-title_short} user interface; see https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7-Beta/html/managing_authentication_for_cloudforms/external_auth[Configuring External Authentication] in _Managing Authentication_ for details.
====
