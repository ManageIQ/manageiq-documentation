...
{solution-title} 1.1 enables you to migrate virtual machines from VMware{nbsp}5.5 (or later) to Red Hat Virtualization or Red Hat OpenStack Platform, using the Red Hat CloudForms user interface.
