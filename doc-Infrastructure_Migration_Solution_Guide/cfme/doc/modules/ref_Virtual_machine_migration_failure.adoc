...
** Check that SSH transformation was correctly configured. See xref:Configuring_the_vmware_hypervisors_for_ssh_transformation[] and xref:Ssh_only_copying_the_vmware_hypervisor_keys_to_the_conversion_hosts[].
...
* SSH transformation failure: Check that SSH transformation was correctly configured. See xref:Configuring_the_vmware_hypervisors_for_ssh_transformation[] and xref:Ssh_only_copying_the_vmware_hypervisor_keys_to_the_conversion_hosts[].
