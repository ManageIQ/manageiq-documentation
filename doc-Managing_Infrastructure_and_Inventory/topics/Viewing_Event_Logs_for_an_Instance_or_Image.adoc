...
ifdef::cfme[See the link:https://access.redhat.com/documentation/en-us/red_hat_cloudforms/4.7/html/general_configuration/[Setting a Default Analysis Profile] section in the CloudForms General Configuration guide.]
