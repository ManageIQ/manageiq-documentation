...
. Check all the events you want to assign to this policy. For a description of the events, see link:https://access.{product-title}.com/documentation/en/{product-title}-{product-title}/version-{product-version}-beta/defining-policies-and-profiles/#chap_events[Events].
